package io.github.scrapery.gateway.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    public AccessControlFilter(RouteLocator routeLocator, SimlifeProperties simLifeProperties) {
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = simLifeProperties.getGateway()
