package io.github.scrapery.gateway.gateway.ratelimiting;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(SimlifeProperties simLifeProperties) {
    ...
    private Supplier<BucketConfiguration> getConfigSupplier() {
        return () -> {
            SimlifeProperties.Gateway.RateLimiting rateLimitingProperties =
                simLifeProperties.getGateway().getRateLimiting();
